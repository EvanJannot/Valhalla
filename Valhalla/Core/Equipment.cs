    ...
    public class Equipment : IEquipment, ITreasure, IDrawable
    {
        ...
        public bool PickUp(IActor actor)
        {
            if (this is HeadEquipment)
            {
                ...
                Game.MessageLog.Add($"{actor.Name} a ramasse un casque en {Name}");
            ...
            if (this is BodyEquipment)
            {
                ...
                Game.MessageLog.Add($"{actor.Name} a ramasse un plastron en {Name}");
                Game.MessageLog.Add(espace.ToString());
                return true;
            }
            ...
            if (this is HandEquipment)
            {
                ...
                Game.MessageLog.Add($"{actor.Name} a ramasse une {Name}");
                Game.MessageLog.Add(espace.ToString());
                return true;
            }
            ...
            if (this is FeetEquipment)
            {
                ...
                Game.MessageLog.Add($"{actor.Name} a ramasse des bottes en {Name}");
                Game.MessageLog.Add(espace.ToString());
                return true;
            }
